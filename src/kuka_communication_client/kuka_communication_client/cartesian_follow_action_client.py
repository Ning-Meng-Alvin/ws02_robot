...
class CartesianFollowClient(Node):
    ...
    def send_goal(self):
        ...
        csv_path = '/home/liyq/ws02_robot/src/kuka_communication_client/csv/1.csv'

        poses = []
        # fixed_orientation = [0.0, 0.0, 0.7071, 0.7071]
        # fixed_orientation = [0.5, -0.5, 0.5, 0.5]
        # fixed_orientation = [0.0,0.7071,0.0,0.7071]
        fixed_orientation = [0.0,0.0,0.0,1.0]
        # fixed_orientation = [0.7071,0,0.7071,0.0]
